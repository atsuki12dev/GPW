  ...
  return (
    <div className={styles.root}>
      ...
      <div className="col2">
        ...
        <p>(1907- 1983гг.) кавалерист, красноармеец. <br />Начало службы ноябрь 1943 года Челябинский ВПП, 50й (или 6й) гвардейский кавалерийский стрелковый полк, затем Семипалатинский ГВК Казахская ССР. <br />Демобилизован в апреле 1945 после ранения. <br />Медаль “За отвагу” 1944г.</p>
      </div>
    </div>
  )
}
